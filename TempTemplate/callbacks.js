...
// // const ctx = new AudioContext();//It role is to manage and play audio
...
// let apiMainPathSample = ""; // 'https://a3hj0l2j2m.execute-api.eu-central-1.amazonaws.com/Prod';
...
// // // Speech generation
// var synth = window.speechSynthesis;//It is a global variable that allows to generate speech convert text to speech
// let voice_idx = 0;
...
//   const loadSoundFile = async (fileName) => {
//     const response = await fetch(soundsPath + fileName);
//     const blob = await response.blob();
//     return URL.createObjectURL(blob);
//   };

//   soundFileGood = await loadSoundFile("/ASR_good.wav");
//   soundFileOkay = await loadSoundFile("/ASR_okay.wav");
//   soundFileBad = await loadSoundFile("/ASR_bad.wav");
// };
...
// // Example of playing the cached sound files
// cacheSoundFiles().then(() => {
//   playSound(soundFileGood);
//   playSound(soundFileOkay);
//   playSound(soundFileBad);
// });
// // const cacheSoundFiles = async () => {
...
//   if (!serverIsInitialized) await initializeServer();//It is a function that initialize the server
...
//   document.getElementById("main_title").innerHTML = "Processing new sample Provided...";
